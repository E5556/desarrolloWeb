...
<?php include('include/sidebar.php');?>				
	...
	<div class="module">
							<div class="module-head">
								<h3>Administar Productos <a href="export.php?type=products" class="btn btn-xs btn-default pull-right" style="margin-top:4px"><i class="icon-download"></i> Exportar CSV</a></h3>
							</div>

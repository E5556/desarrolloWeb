...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		mysqli_stmt_bind_param($stmt, 'ssssi', $baddress, $bstate, $bcity, $bpincode, $uid);
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		mysqli_stmt_bind_param($stmt, 'ssssi', $saddress, $sstate, $scity, $spincode, $uid);
		if(mysqli_stmt_execute($stmt)) {
	...
	<!-- panel-heading -->
    	...
    	<h4 class="unicase-checkout-title">
	        <a data-toggle="collapse" class="" data-parent="#accordion" href="#collapseOne">
	          <span>1</span>Dirección de entrega
	        </a>
	     </h4>
    </div>
    <!-- panel-heading -->
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Dirección de entrega<span>*</span></label>
...
?>
					...
					<form class="register-form" role="form" method="post">
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Dirección de entrega<span>*</span></label>
